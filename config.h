...
//#include "/home/christian/.cache/wal/colors-wal-dwm.h"
...
static const char *volchange[]  = { "kill",           "-44",             "$(pidof dwmblocks)", NULL };
static const char *downvol[]    = { "/usr/bin/pactl", "set-sink-volume", "0", "-10%",          NULL };
static const char *mutevol[]    = { "/usr/bin/pactl", "set-sink-mute",   "0", "toggle",        NULL };

static const char *bright_up[] = {"brightnessctl", "s", "+10%", NULL};
static const char *bright_down[] = {"brightnessctl", "s", "10%-", NULL};
...
static const Key keys[] = {
	...
	{ 0,                            XF86XK_AudioLowerVolume,        spawn,  SHCMD("kill -44 $(pidof dwmblocks)") },
        { 0,                            XF86XK_AudioMute,               spawn,  SHCMD("kill -44 $(pidof dwmblocks)") },
        { 0,                            XF86XK_AudioRaiseVolume,        spawn,  SHCMD("kill -44 $(pidof dwmblocks)") },
